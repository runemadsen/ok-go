...
A Golang web application template with most of the stuff you've come to enjoy from Ruby on Rails. For more information, [read the blog post](LINK HEEEERE).Pull requests are more than encouraged!
